...
class SearchIndexPersistenceAdapter(
    ...
    override suspend fun updateMemberFields(memberId: Long, nickname: String, profileImageUrl: String?): Int {
        return searchIndexRepository.updateMemberFields(memberId, nickname, profileImageUrl)
    }
}
